...
//   const INITIAL_SUPPLY = ethers.parseUnits("1000000000", 18); // 1B tokens with 18 decimals
...
//     const BasicERC20 = await ethers.getContractFactory("MyToken");
//     token = await BasicERC20.deploy();
//     await token.waitForDeployment();
//   });

//   describe("Deployment", function () {
//     it("deploys successfully with correct owner", async function () {
...
//     it("sets the correct total supply and assigns it to the owner", async function () {
...
//     it("allows the owner to transfer tokens and updates balances correctly", async function () {
...
//     it("reverts when trying to transfer more than the sender balance", async function () {
//       const ownerBalance = await token.balanceOf(owner.address);
...
//     it("allows transferFrom using approved allowance and decreases allowance properly", async function () {
...
//     it("reverts transferFrom when there is no approval", async function () {
...
//     it("total supply equals sum of balances after several transfers", async function () {
...
//       const sumOfBalances = ownerBalance + addr1Balance + addr2Balance;
//       const totalSupply = await token.totalSupply();
